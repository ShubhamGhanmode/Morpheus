...
mixin _$PlannedExpense {
 ...
 String get id; String get title; double get amount;@JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson) DateTime get dueDate; String? get category;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,amount,dueDate,category);

@override
String toString() {
  return 'PlannedExpense(id: $id, title: $title, amount: $amount, dueDate: $dueDate, category: $category)';
}
...
@useResult
$Res call({
 String id, String title, double amount,@JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson) DateTime dueDate, String? category
});
...
/// Create a copy of PlannedExpense
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? amount = null,Object? dueDate = null,Object? category = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  double amount, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson)  DateTime dueDate,  String? category)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlannedExpense() when $default != null:
return $default(_that.id,_that.title,_that.amount,_that.dueDate,_that.category);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  double amount, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson)  DateTime dueDate,  String? category)  $default,) {final _that = this;
switch (_that) {
case _PlannedExpense():
return $default(_that.id,_that.title,_that.amount,_that.dueDate,_that.category);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  double amount, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson)  DateTime dueDate,  String? category)?  $default,) {final _that = this;
switch (_that) {
case _PlannedExpense() when $default != null:
return $default(_that.id,_that.title,_that.amount,_that.dueDate,_that.category);case _:
  return null;
...
class _PlannedExpense extends PlannedExpense {
   _PlannedExpense({required this.id, required this.title, required this.amount, @JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson) required this.dueDate, this.category}): super._();
  factory _PlannedExpense.fromJson(Map<String, dynamic> json) => _$PlannedExpenseFromJson(json);

@override final  String id;
@override final  String title;
@override final  double amount;
@override@JsonKey(fromJson: dateTimeFromJson, toJson: dateTimeToJson) final  DateTime dueDate;
...
/// Create a copy of PlannedExpense
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? amount = null,Object? dueDate = null,Object? category = freezed,}) {
